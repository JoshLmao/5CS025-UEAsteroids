...
AShipProjectile::AShipProjectile()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ProjectileMesh(TEXT("StaticMesh'/Game/Models/Player_Projectile/SM_double_shot_projectile.SM_double_shot_projectile'"));
