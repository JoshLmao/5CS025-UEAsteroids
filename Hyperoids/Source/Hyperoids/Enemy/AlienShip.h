...
/**
 * An Enemey NPC ship that can move inside a play area and fire at the 
 * current player while also rewarding the player with points
 */
UCLASS()
...
public:	
	...
	//! Determines any collisions and looks for player's projectile
	UFUNCTION()
